...
class EquationListView extends StatefulWidget {
  const EquationListView({Key key, this.callBack}) : super(key: key);
...
class _PopularCourseListViewState extends State<EquationListView>
            ...
            child: InkWell(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => DetailScreen(todo: category),
                  ),
                );
              },
              child: SizedBox(
